...
This release represents a complete architectural rewrite and security hardening phase, transforming VigiLo from an engineering script collection into a modular Windows security application.
